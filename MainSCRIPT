...
GUITOGGLE.Position = UDim2.new(0, 0, 0.504913986, 0)
GUITOGGLE.Size = UDim2.new(0, 61, 0, 22)
...
REGISTERESPOFF.Text = "REGISTER ESP  OFF"
...
REGISTERESPON.Text = "REGISTER ESP  ON"
